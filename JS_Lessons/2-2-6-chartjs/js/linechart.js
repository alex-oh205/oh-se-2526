...
async function getData() {
    ...
    table.forEach(row => {
        ...
        xYears.push(year);                          // Push each year into array for years
    ...
    return { xYears, yTemps, yNHtemps, ySHtemps };    // Use {} to return multiple values as an object
}
    ...
    const myChart = new Chart(lineChart, {  // Construct the chart    
        ...
        data: {                         // Define data
            ...
            datasets: [                 // Each object describes one dataset of y-values
                ...
                {
                    label:    `Northern Hemisphere LSA and SSW Temperature in ${degreeSymbol}C`,     // Dataset label for legend
                    data:     data.yNHtemps,
                    fill:     false,           // Fill area under the linechart (true = yes, false = no)
                ...
                {
                    label:    `Southern Hemisphere LSA and SSW Temperature in ${degreeSymbol}C`,     // Dataset label for legend
                    data:     data.ySHtemps,
                    fill:     false,           // Fill area under the linechart (true = yes, false = no)
