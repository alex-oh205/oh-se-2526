...
earth_small2 = earth_img.resize((91, 90))
fig2, axes2 = plt.subplots(1, 2)
axes2[0].imshow(earth_img)
axes2[1].imshow(earth_small)
#fig2.show()

# Paste earth into left and right eye and display
# Uses alpha from mask
student_img.paste(earth_small, (1162, 966), mask=earth_small)
student_img.paste(earth_small2, (705, 930), mask=earth_small2)  
# Display
...
# print(earth_img.size)      # earth image size
# print(earth_small.size)    # earth_small size
# print(earth_img.size[1])   # width of earth image
